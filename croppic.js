...
(function(window, document) {
    ...
    Croppic.prototype = {
        ...
        createModal: function() {
            ...
            var modalHTML = '<div id="croppicModal"><div id="croppicModalObj" style="width: ' + that.objW + 'px; height: ' + that.objH + 'px; margin: ' + marginTop + 'px auto 0; position: relative;"></div></div>';
        ...
        initialScaleImg: function() {
            ...
            if (that.options.enableMousescroll) {
                that.img.on('mousewheel', function(e) {
                    e.preventDefault();

                    that.zoom(that.options.zoomFactor * e.deltaY);
                });
            }
        ...
        createFallbackIframe: function() {
            ...
            if (!that.isAjaxUploadSupported()) {
                ...
                var myContent = '<!DOCTYPE html>' +
                    ...
                    $('#' + that.id + '_imgUploadField')[0].outerHTML + '</form></body></html>';
